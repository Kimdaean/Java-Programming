...
public class FigureEditorTest {
	public static void main(String[] args) {
		...
		Shape r1 = new Rectangle(1,2,3,4); //Rectangle 클래스에서 r1 변수 생성
		Shape r2 = new Rectangle(2,3,4,5); //Rectangle 클래스에서 r2 변수 생성
		Shape c1 = new Circle(3,4,5); //Circle 클래스에서 c1 변수 생성
		Shape c2 = new Circle(4,5,6); //Circle 클래스에서 c2 변수 생성
		editor.add(r1);	//editor에 r1 저장하가
		...
		editor.display(); //새로운 값이 추가되고 중복된 값은 추가되지 않았는지 확인하기 위해 출력
	}
}